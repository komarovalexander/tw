...
`,tn=function(e){var r=u.useContext(_),t=r.csp,o=r.prefixCls,a=rn;o&&(a=a.replace(/anticon/g,o)),u.useEffect(function(){var i=e.current,c=H(i);M(a,"@ant-design-icons",{prepend:!0,csp:t,attachTo:c})},[])},on=["icon","className","onClick","style","primaryColor","secondaryColor"],g={primaryColor:"#333",secondaryColor:"#E6E6E6",calculated:!1};function an(n){var e=n.primaryColor,r=n.secondaryColor;g.primaryColor=e,g.secondaryColor=r||E(e),g.calculated=!!r}function ln(){return f({},g)}var b=function(e){var r=e.icon,t=e.className,o=e.onClick,a=e.style,i=e.primaryColor,c=e.secondaryColor,y=A(e,on),m=u.useRef(),s=g;if(i&&(s={primaryColor:i,secondaryColor:c||E(i)}),tn(m),en(P(r),"icon should be icon definiton, but got ".concat(r)),!P(r))return null;var l=r;return l&&typeof l.icon=="function"&&(l=f(f({},l),{},{icon:l.icon(s.primaryColor,s.secondaryColor)})),h(l.icon,"svg-".concat(l.name),f(f({className:t,onClick:o,style:a,"data-icon":l.name,width:"1em",height:"1em",fill:"currentColor","aria-hidden":"true"},y),{},{ref:m}))};b.displayName="IconReact";b.getTwoToneColors=ln;b.setTwoToneColors=an;function R(n){var e=N(n),r=k(e,2),t=r[0],o=r[1];return b.setTwoToneColors({primaryColor:t,secondaryColor:o})}function cn(){var n=b.getTwoToneColors();return n.calculated?[n.primaryColor,n.secondaryColor]:n.primaryColor}var sn=["className","icon","spin","rotate","tabIndex","onClick","twoToneColor"];R(q.primary);var T=u.forwardRef(function(n,e){var r=n.className,t=n.icon,o=n.spin,a=n.rotate,i=n.tabIndex,c=n.onClick,y=n.twoToneColor,m=A(n,sn),s=u.useContext(_),l=s.prefixCls,p=l===void 0?"anticon":l,z=s.rootClassName,$=F(z,p,w(w({},"".concat(p,"-").concat(t.name),!!t.name),"".concat(p,"-spin"),!!o||t.name==="loading"),r),C=i;C===void 0&&c&&(C=-1);var D=a?{msTransform:"rotate(".concat(a,"deg)"),transform:"rotate(".concat(a,"deg)")}:void 0,L=N(y),O=k(L,2),W=O[0],B=O[1];return u.createElement("span",v({role:"img","aria-label":t.name},m,{ref:e,tabIndex:C,onClick:c,className:$}),u.createElement(b,{icon:t,primaryColor:W,secondaryColor:B,style:D}))});T.displayName="AntdIcon";T.getTwoToneColor=cn;T.setTwoToneColor=R;export{T as I,v as _};
